...
public class ClientNaiveAgent implements Runnable {
...

    {
        ...
        // If the level is loaded (in PLAYING　state)but no slingshot detected, then
        // the agent will request to fully zoom out.
                ...
                if (_sling != null) {
                    ...
                    if (scale_diff < 25) {
                        ...
                        if (dx < 0) {
                            ...
                            System.out
                                    .println("It takes " + (System.currentTimeMillis() - timer) + " ms to take a shot");
                            state = ar.checkState();
