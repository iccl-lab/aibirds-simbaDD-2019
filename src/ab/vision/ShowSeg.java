...
public class ShowSeg implements Runnable {
    private static List<Rectangle> pigs, redBirds, blueBirds, yellowBirds, blackBirds, whiteBirds, iceBlocks,
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (frame == null) {
                ...
                frame = new ImageSegFrame("Image Segmentation", screenshot, null);
            } else {
                frame.refresh(screenshot, null);
            }
