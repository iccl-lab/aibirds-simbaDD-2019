...
public class GameStateExtractor {
    ...
    public GameStateExtractor() {
        try {
            ...
            _gamewon1 = ImageIO.read(getClass().getResource("resources/gamewon1.png"));
            _gamewon2 = ImageIO.read(getClass().getResource("resources/gamewon2.png"));
            _gamelost = ImageIO.read(getClass().getResource("resources/gamelost.png"));
            _endGame0 = ImageIO.read(getClass().getResource("resources/0endScreen.png"));
            _endGame1 = ImageIO.read(getClass().getResource("resources/1endScreen.png"));
            _endGame2 = ImageIO.read(getClass().getResource("resources/2endScreen.png"));
            _endGame3 = ImageIO.read(getClass().getResource("resources/3endScreen.png"));
            _endGame4 = ImageIO.read(getClass().getResource("resources/4endScreen.png"));
            _endGame5 = ImageIO.read(getClass().getResource("resources/5endScreen.png"));
            _endGame6 = ImageIO.read(getClass().getResource("resources/6endScreen.png"));
            _endGame7 = ImageIO.read(getClass().getResource("resources/7endScreen.png"));
            _endGame8 = ImageIO.read(getClass().getResource("resources/8endScreen.png"));
            _endGame9 = ImageIO.read(getClass().getResource("resources/9endScreen.png"));
    ...
    public GameState getGameState(BufferedImage screenshot) {
        ...
        if (VisionUtils.imageDifference(wnd, _gamewon1) < numBytes * avgColourThreshold
                || VisionUtils.imageDifference(wnd, _gamewon2) < numBytes * avgColourThreshold) {
    ...
    public int getScoreInGame(BufferedImage screenshot) {
        ...
        for (int i = 0; i < letters.length; i++) {
            ...
            BufferedImage letterImage = scoreImage
                    .getSubimage(letters[i].x, letters[i].y, letters[i].width, letters[i].height);
        ...
        /*
         * VisionUtils.drawBoundingBoxes(scoreImage, letters, Color.BLUE); if (_debug ==
    ...
    public int getScoreEndGame(BufferedImage screenshot) {
        ...
        BufferedImage[] endGameNumberTemplates = {
                extractNumber(_endGame0),
                extractNumber(_endGame1),
                extractNumber(_endGame2),
                extractNumber(_endGame3),
                extractNumber(_endGame4),
                extractNumber(_endGame5),
                extractNumber(_endGame6),
                extractNumber(_endGame7),
                extractNumber(_endGame8),
        ...
        /*
         * if (score != prevScore) { saved = false; repeatCount = 0; prevScore = score;
         * } else if (score != 0 && !saved) { repeatCount++; if (repeatCount > 0) {
         * saved = true; try { File outputfile = new File("scoreImage/" + score +
         * ".png"); ImageIO.write(saveImage, "png", outputfile); } catch (IOException e)
         * {
         * 
         * } } }
         */
