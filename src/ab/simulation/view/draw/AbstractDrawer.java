...
public abstract class AbstractDrawer {
    ...
    public AbstractDrawer(IViewportTransform viewport) {
        m_drawFlags = 0;
    ...
    /**
     * Takes the world coordinates and puts the corresponding screen coordinates in
     * argScreen.
     * 
     * @param worldX
     * @param worldY
    ...
    /**
     * takes the screen coordinates and puts the corresponding world coordinates in
     * argWorld.
     * 
     * @param screenX
     * @param screenY
