...
public class ImageSegFrame {
    ...
    public class ImagePanel extends JPanel implements KeyListener, MouseListener {
        ...
        public void keyPressed(KeyEvent key) {
            ...
            if (key.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                BufferedImage bi = new BufferedImage(_img.getWidth(null), _img.getHeight(null),
    ...
    public ImageSegFrame(String name, Image img, int[][] meta, int bound_x, int bound_y) {
        ...
        frame.setSize(
                img.getWidth(null) + insets.left + insets.right,
    ...
    public static void main(String args[]) throws InterruptedException, IOException {
        ...
        /*
         * if(recordScreenshot) for (BufferedImage image : images) { String imgFilename
         * = saveFileDir + String.format("img%04d.png", _saveCount ++);
         * ImageIO.write(image, "png", new File(imgFilename)); }
         */
